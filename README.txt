...
4. traffic_visualizations.ipynb, python code used to generate the interactive plot (communication data)
5. sensor_vis.qmd, R code used to generate the visualizations for the movement data
